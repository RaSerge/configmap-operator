...
import (
	...
	"github.com/raserge/configmap-operator/pkg/genapi"
)

const (
	name = "configmapmake-controller"
	repo = "github.com/raserge/configmap-operator"
...
func generateDocs() error {
	pkg, err := genapi.ParsePackage("github.com/raserge/configmap-operator/pkg/api/v1alpha1")
	if err != nil {
		return err
	}
